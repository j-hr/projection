...
mpirun --display-map --map-by core --bind-to core python main.py real ipcs1 HYK 2 0.001 -S only_vel --savespace 10 --onset 0.5 --stab 0.5 --prv1 12 --pav1 4 --precV hypre_amg --bcv LAP -n TEST2AMG
