...
for (path, vector_name, rv) in load:
    ...
    rv.ResetCamera()
    # set scalar coloring
    ColorBy(velocityDisplay, ('POINTS', vector_name))
    # rescale color and/or opacity maps used to include current data range
    velocityDisplay.RescaleTransferFunctionToDataRange(True)
    # show color bar/color legend
    velocityDisplay.SetScalarBarVisibility(rv, True)
